...
//echo $id;
    ...
    $query="select * from villa v , city c where c.id = v.cid and v.cid =:id";
       ...
       echo '<br>'.$r['vdesc'].'<br>';
        ...
        ?>  </b>
               ...
               <div class="card-footer">
                   &emsp;<a href="<?php echo $r['villaint'];?>">
                       <input type="button"  class="btn btn-primary" value="View Interior"></a>&emsp;
                   <a href="<?php echo $r['vpayment'];?>">
                       <input type="button"  class="btn btn-danger" value="Book Villa"></a>
